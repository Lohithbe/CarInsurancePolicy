...
{
    /**
     * @var \HofUniversity\CarRental\Domain\Model\Rental
     */
    ...
    {
        parent::setUp();
        $this->subject = new \HofUniversity\CarRental\Domain\Model\Rental();
    }
    ...
    {
        $customerFixture = new \HofUniversity\CarRental\Domain\Model\Customer();
