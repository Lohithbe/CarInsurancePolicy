...
return [
    'ctrl' => [
        ...
        'searchFields' => 'color,vin,images,brand,tires,rentals',
        'iconfile' => 'EXT:car_rental/Resources/Public/Icons/tx_carrental_domain_model_car.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, color, vin, images, brand, tires, rentals',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, color, vin, images, brand, tires, rentals, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
