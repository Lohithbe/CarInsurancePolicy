...
CREATE TABLE tx_carrental_domain_model_car (
	...
	vin varchar(255) DEFAULT '' NOT NULL,
	color varchar(255) DEFAULT '' NOT NULL,
	brand int(11) unsigned DEFAULT '0',
	tires int(11) unsigned DEFAULT '0' NOT NULL,
	rentals int(11) unsigned DEFAULT '0' NOT NULL,
...
CREATE TABLE tx_carrental_domain_model_tire (
	...
	tread_depth double(11,2) DEFAULT '0.00' NOT NULL,
	pressure double(11,2) DEFAULT '0.00' NOT NULL,
