...
return [
    'ctrl' => [
        ...
        'searchFields' => 'vin,color,brand,tries,rentals',
        'iconfile' => 'EXT:car_rental/Resources/Public/Icons/tx_carrental_domain_model_car.gif'
    ],
    'interface' => [
        'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, vin, color, brand, tries, rentals',
    ],
    'types' => [
        '1' => ['showitem' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, vin, color, brand, tries, rentals, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
    'columns' => [
        'sys_language_uid' => [
            'exclude' => true,
        ...
        'tries' => [
            'exclude' => true,
            'label' => 'LLL:EXT:car_rental/Resources/Private/Language/locallang_db.xlf:tx_carrental_domain_model_car.tries',
            'config' => [
                'type' => 'inline',
