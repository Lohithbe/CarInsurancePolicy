...
plugin.tx_carrental_management {
    view {
        templateRootPaths.0 = EXT:car_rental/Resources/Private/Templates/
        templateRootPaths.1 = {$plugin.tx_carrental_management.view.templateRootPath}
        partialRootPaths.0 = EXT:car_rental/Resources/Private/Partials/
        partialRootPaths.1 = {$plugin.tx_carrental_management.view.partialRootPath}
        layoutRootPaths.0 = EXT:car_rental/Resources/Private/Layouts/
        layoutRootPaths.1 = {$plugin.tx_carrental_management.view.layoutRootPath}
    }
    persistence {
        storagePid = {$plugin.tx_carrental_management.persistence.storagePid}
        #recursive = 1
    }
    features {
        #skipDefaultArguments = 1
